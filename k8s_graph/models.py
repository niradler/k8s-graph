...
class RelationshipType(str, Enum):
    ...
    ARGOCD_MANAGED = "argocd_managed"
    ARGO_WORKFLOW_SPAWNED = "argo_workflow_spawned"
    AIRFLOW_TASK = "airflow_task"
    FLUX_MANAGED = "flux_managed"
    ISTIO_ROUTE = "istio_route"
    KNATIVE_SERVES = "knative_serves"
    CERT_ISSUED = "cert_issued"
    TEKTON_RUN = "tekton_run"
    PROMETHEUS_MONITOR = "prometheus_monitor"
    KEDA_SCALE = "keda_scale"
    VELERO_BACKUP = "velero_backup"
