...
class CrossplaneHandler(BaseCRDHandler):
    def supports(self, resource: dict[str, Any]) -> bool:
        ...
        return (
            (kind in ["Composition", "CompositeResourceDefinition"] and "crossplane.io" in api_version) or
            "crossplane.io/claim-name" in annotations or
            "crossplane.io/claim-namespace" in annotations
        )
    ...
    async def discover(self, resource: dict[str, Any]) -> list[ResourceRelationship]:
        ...
        try:
            ...
            if kind == "Composition" and self.client:
                ...
                try:
                    all_resources_kinds = ["Deployment", "Service", "ConfigMap", "Secret", "StatefulSet"]
                    ...
                    for res_kind in all_resources_kinds:
                        ...
                        for res in resources:
                            ...
                            if (res_annotations.get("crossplane.io/composition-resource-name") or
                                res_labels.get("crossplane.io/composite")):
                                relationships.append(
                                    ResourceRelationship(
                                        source=source_id,
